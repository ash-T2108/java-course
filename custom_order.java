...
public class custom_order {
    ...
    public static void main(String[] args) {
        ...
        // first to output a small message to the console 
        System.out.println("Hello user, welcome to Github!!\nWe are using Netbeans v8!"); // print Hello World to console
        
    // TEST CODE
    
    // STEP 2 CREATE A SCANNER OBEJCT, DECLARE VARAIBLES, & PRINT STATEMENTS
	  
    // Scanner object to allow user input, it makes use of the console
    Scanner keyboard;//declaration statement
    //we need to create the object keyboard in memory to be able to use it
